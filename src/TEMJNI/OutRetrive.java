...
public class OutRetrive {
  ...
  public OutRetrive(long cPtr, boolean cMemoryOwn) {
    swigCMemOwn = cMemoryOwn;
    swigCPtr = cPtr;
  }

  public static long getCPtr(OutRetrive obj) {
  ...
  public void setEnvoddly(SWIGTYPE_p_a_31__EnvDataDly value) {
    temcoreJNI.OutRetrive_envoddly_set(swigCPtr, this, SWIGTYPE_p_a_31__EnvDataDly.getCPtr(value));
  }

  public SWIGTYPE_p_a_31__EnvDataDly getEnvoddly() {
    long cPtr = temcoreJNI.OutRetrive_envoddly_get(swigCPtr, this);
    return (cPtr == 0) ? null : new SWIGTYPE_p_a_31__EnvDataDly(cPtr, false);
  }

  public void setEnvoddlyall(SWIGTYPE_p_EnvDataDly value) {
    temcoreJNI.OutRetrive_envoddlyall_set(swigCPtr, this, SWIGTYPE_p_EnvDataDly.getCPtr(value));
  }

  public SWIGTYPE_p_EnvDataDly getEnvoddlyall() {
    long cPtr = temcoreJNI.OutRetrive_envoddlyall_get(swigCPtr, this);
    return (cPtr == 0) ? null : new SWIGTYPE_p_EnvDataDly(cPtr, false);
  }
