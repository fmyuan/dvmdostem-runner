...
public class ConstTime{
	public final static int DINY = temcore.getDINY(); 
	...
	public final static int MIN_EQ_YR = temcore.getMIN_EQ_YR(); // minimum number of years for equilibrium run
	public final static int MAX_EQ_YR = temcore.getMAX_EQ_YR(); // maximum number of years for equilibrium run
	...
	public final static int END_SP_YR = temcore.getBEG_SP_YR(); // starting year of spin-up
	public final static int BEG_SP_YR = temcore.getEND_SP_YR(); // ending year of spin-up
