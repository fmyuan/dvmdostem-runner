...
public class ConstLayer {
	...
	public final static int MAX_GRN_LAY = temcore.getMAX_GRN_LAY(); //maximum number of Ground Layer
	...
	public final static double MINSLWTHICK = temcore.getMINSLWTHICK();   //minimum thickness (meter) for forming a shallow organic layer
	public final static double MINDEPTHICK = temcore.getMINDEPTHICK();   //minimum thickness (meter) for forming a deep organic layer
